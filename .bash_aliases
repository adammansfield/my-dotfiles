...
alias gcad='git commit --amend --date '
alias gco='git checkout'
alias gcwip='git commit -m "[WIP] $(date +%Y-%m-%dT%H:%M)"'
alias gd='git diff'
...
alias rgrep='grep -Inr --color=auto --exclude-dir=.git --exclude-dir=bin --exclude-dir=obj'
...
alias ...='cd ../..'
alias cs='cygstart'
alias drhw='docker run hello-world'
alias pong='ping 8.8.8.8'
alias relaydocker='nohup ~/relay-docker.sh &'
